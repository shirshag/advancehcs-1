...
const paths: Record<string, string> = {
  ...
  whatsapp: "M20.5 11.8a8.5 8.5 0 0 1-12.7 7.4L3 20.5l1.3-4.6A8.5 8.5 0 1 1 20.5 11.8ZM8.2 7.7c-.2.4-.6 1.2-.4 2 .4 1.8 2.4 4.3 5 5.4 1 .4 1.7.3 2.2 0 .4-.3.8-1.1.8-1.5 0-.3-.2-.4-.5-.5l-1.5-.7c-.3-.1-.5 0-.7.2l-.5.7c-.2.2-.4.2-.7.1-1-.4-1.8-1-2.5-2-.2-.3-.2-.5 0-.7l.5-.6c.2-.2.2-.4.1-.7L9.3 8c-.1-.3-.3-.4-.6-.4h-.5Z",
