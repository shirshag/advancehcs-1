...
const aahilDoctorSeeds: DoctorSeed[] = [
  ...
  { slug: "dr-sudip-roy-aahil", name: "Dr. Sudip Roy", designation: "Medicine", speciality: "general-medicine", qualification: "MBBS, MD", availability: "Every Monday & Thursday" },
  { slug: "dr-manjunath-poral-aahil", name: "Dr. Manjunath Poral", designation: "Medicine", speciality: "general-medicine", qualification: "MBBS, MD", availability: "Every Saturday & Sunday" },
  { slug: "dr-p-k-sinha-aahil", name: "Dr. P K Sinha", designation: "Medicine", speciality: "general-medicine", qualification: "MBBS, MD", availability: "Every Friday" },
  { slug: "dr-swapan-dab-aahil", name: "Dr. Swapan Dab", designation: "Medicine", speciality: "general-medicine", qualification: "MBBS", availability: "Everyday" },
  { slug: "dr-rajarshi-dey-aahil", name: "Dr. Rajarshi Dey", designation: "General Surgeon", speciality: "surgery", qualification: "MBBS, MS", availability: "Every Monday & Thursday" },
  { slug: "dr-biswajit-panda-aahil", name: "Dr. Biswajit Panda", designation: "General Surgeon", speciality: "surgery", qualification: "MBBS, MS", availability: "Every Day (Oncall)" },
  { slug: "dr-gairik-bera-aahil", name: "Dr. Gairik Bera", designation: "Gynocologist", speciality: "gynaecology-obstetrics", qualification: "MBBS, MS", availability: "Every Wednesday" },
  { slug: "dr-bibhas-mandal-aahil", name: "Dr. Bibhas Mandal", designation: "Gynocologist", speciality: "gynaecology-obstetrics" },
  { slug: "dr-alolika-deb-aahil", name: "Dr. Alolika Deb", designation: "Gynocologist", speciality: "gynaecology-obstetrics", qualification: "MBBS, MS", availability: "Every Tuesday & Wednesday" },
  { slug: "dr-swagato-ray-aahil", name: "Dr. Swagato Ray", designation: "ENT", speciality: "ent-head-neck", qualification: "MBBS, MS", availability: "Every Monday" },
  { slug: "dr-anamika-aahil", name: "Dr. Anamika", designation: "ENT", speciality: "ent-head-neck" },
  { slug: "dr-uttayan-chakraborty-aahil", name: "Dr. Uttayan Chakraborty", designation: "Nephro", speciality: "nephrology", qualification: "MBBS, MD, DM", availability: "4th Tuesday (every month)" },
  { slug: "dr-amlan-kanti-biswas-aahil", name: "Dr. Amlan Kanti Biswas", designation: "Nephro", speciality: "nephrology", qualification: "MBBS, MD, DM", availability: "2nd & 4th Friday (every month)" },
  { slug: "dr-md-sarwar-aahil", name: "Dr. MD Sarwar", designation: "Neuro", speciality: "neuro-surgery", qualification: "MBBS, MS, MCh", availability: "2nd & 4th Friday (every month)" },
  { slug: "dr-sumit-arora-aahil", name: "Dr. Sumit Arora", designation: "Neuro", speciality: "neuro-surgery", qualification: "MBBS, MS, MCh", availability: "Every Sunday" },
  { slug: "dr-dipankar-pal-aahil", name: "Dr. Dipankar Pal", designation: "Neuro", speciality: "neurology", qualification: "MBBS, MD, DM", availability: "1st & 3rd Wednesday (every month)" },
  { slug: "dr-abdul-latif-aahil", name: "Dr. Abdul Latif", designation: "Ortho", speciality: "orthopaedics", qualification: "MBBS, MS" },
  { slug: "dr-kuldip-mukherjee-aahil", name: "Dr. Kuldip Mukherjee", designation: "Ortho", speciality: "orthopaedics", qualification: "MBBS, MS" },
  { slug: "dr-jieshnu-mukhopadhyay-aahil", name: "Dr. Jieshnu Mukhopadhyay", designation: "Ortho", speciality: "orthopaedics", qualification: "MBBS, D-Ortho" },
  { slug: "dr-biplab-barman-aahil", name: "Dr. Biplab Barman", designation: "Ortho", speciality: "orthopaedics", qualification: "MBBS, MS" },
  { slug: "dr-saptarsi-mukherjee-aahil", name: "Dr. Saptarsi Mukherjee", designation: "Ortho", speciality: "orthopaedics", qualification: "MBBS, MS" },
  { slug: "dr-chayan-kumar-pal-aahil", name: "Dr. Chayan Kumar Pal", designation: "Ortho", speciality: "orthopaedics", qualification: "MBBS, MS" },
  { slug: "dr-subhra-prakash-pramanik-aahil", name: "Dr. Subhra Prakash Pramanik", designation: "Cardio", speciality: "cardiology", qualification: "MBBS, MD, DM", availability: "Every Friday & Saturday" },
  { slug: "dr-samujjal-das-aahil", name: "Dr. Samujjal Das", designation: "Maxillo & Dental", speciality: "maxillofacial-dental", qualification: "BDS, MDS", availability: "2nd & 4th Friday (every month)" },
  { slug: "dr-purnimesh-mandal-aahil", name: "Dr. Purnimesh Mandal", designation: "Maxillo & Dental", speciality: "maxillofacial-dental", qualification: "BDS", availability: "Monday, Tuesday & Wednesday" },
  { slug: "dr-shoumik-banerjee-aahil", name: "Dr. Shoumik Banerjee", designation: "Chest Medicine", speciality: "chest-medicine" },
  { slug: "dr-subham-chanda-aahil", name: "Dr. Subham Chanda", designation: "Chest Medicine", speciality: "chest-medicine", availability: "Every Sunday" },
  { slug: "dr-maharaj-mandal-aahil", name: "Dr. Maharaj Mandal", designation: "Urologist", speciality: "urology" },
  { slug: "dr-sidharta-dutta-aahil", name: "Dr. Sidharta Dutta", designation: "Urologist", speciality: "urology" },
  { slug: "dr-md-dawood-khan-aahil", name: "Dr. MD Dawood Khan", designation: "Urologist", speciality: "urology" },
  { slug: "dr-saikat-sheet-aahil", name: "Dr. Saikat Sheet", designation: "Oncologist", speciality: "oncology", availability: "Everyday (Oncall)" },
  { slug: "dr-deepak-dash-aahil", name: "Dr. Deepak Dash", designation: "Pain Management", speciality: "pain-management", qualification: "MBBS, MD", availability: "Every Monday" },
  { slug: "santanu-dutta-aahil", name: "Santanu Dutta", designation: "CTVS", speciality: "cardiology" },
  { slug: "dr-ayan-ghosh-aahil", name: "Dr. Ayan Ghosh", designation: "Pediatric", speciality: "paediatrics" },
  { slug: "dr-himadri-sekhar-kisku-aahil", name: "Dr. Himadri Sekhar Kisku", designation: "Pediatric", speciality: "paediatrics", availability: "Every Monday (9.30 AM)" },
  { slug: "dr-arindam-bose-aahil", name: "Dr. Arindam Bose", designation: "Gastro", speciality: "general-medicine", qualification: "MBBS, MD, DM", availability: "1st & 3rd Sunday (every month)" }
